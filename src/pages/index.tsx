  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Dynamically generates gantt chart and calculates TAT (turnaround time) and WAT (waiting time) based on various process CPU scheduling algorithms."
        />
        ...
        <meta
          property="og:image"
          content="https://famouzcoder.com/famouz-process-scheduling/meta.png"
        />
        <meta
          property="og:url"
          content="https://famouzcoder.com/famouz-process-scheduling"
        />
        ...
        <meta
          name="twitter:image"
          content="https://famouzcoder.com/process-scheduling-solver/meta.png"
        />
      ...
      <Footer className="container">
        <a
          href="https://github.com/FaithFamous2/famouz-process-scheduling"
          target="_blank"
        ...
        <Separator />
        <a
          href="https://famouzcoder.com/#contact"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
